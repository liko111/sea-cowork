...
namespace MH.WaterCausticsModules {
    public class WaterCausticsEffectMenuItem {
        ...
        static public void CreateEffectGO () {
            ...
            var effect = createEffectGO ();
            WaterCausticsTexGenerator texGen = null;
            if (selectedGO != null)
                texGen = selectedGO.GetComponent<WaterCausticsTexGenerator> ();
            if (texGen == null)

#if UNITY_2022_3_OR_NEWER
                texGen = Object.FindAnyObjectByType<WaterCausticsTexGenerator> ();
#elif UNITY_2021_3_OR_NEWER
                texGen = Object.FindFirstObjectByType<WaterCausticsTexGenerator> ();
#else
