	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float dotResult13 = dot( SafeNormalize(_MainLightPosition.xyz) , float3(0,1,0) );
				float2 appendResult33 = (float2(WorldPosition.x , WorldPosition.z));
				float2 v2182 = ( ( ( ( SurfaceY137 - WorldPosition.y ) * ( (SafeNormalize(_MainLightPosition.xyz)).xz / max( dotResult13 , 0.001 ) ) ) + appendResult33 ) * _WCECF_Density );
...
/*ASEBEGIN
Version=19002
-1519.2;25.6;1509.6;772.6;5603.924;2200.85;5.42404;True;False
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;12;-3273.956,-828.8858;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;207;-770.7977,290.787;Inherit;False;Global;_WCECF_IntensityMainLit;_WCECF_IntensityMainLit;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=7CD5CD0078B388BBA72C20409A91DCC8B69D1F96