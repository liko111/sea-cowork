	...
	SubShader
	{
		...
		Pass
		{
			...
			void PragmaMultiCompile( float In0 )
			{
				...
				// 反射Probeを使用するために必要
				#if UNITY_VERSION >= 60010000 // Unity6.1.0 URP17.1 以上
					#pragma multi_compile_fragment _ _CLUSTER_LIGHT_LOOP
				#elif UNITY_VERSION >= 202220 // Unity2022.2.0 URP14.0 以上
...
/*ASEBEGIN
Version=19002
-1519.2;25.6;1509.6;772.6;-2996.443;950.5083;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;383;4098.89,-716.9291;Inherit;False;474.4234;252.5571;Comment;1;384;Pragma Multi Compile;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;311;-4739.162,831.2217;Inherit;False;Global;_DemoTime;_DemoTime;22;0;Create;True;0;0;0;False;0;False;0;234.3441;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;384;4258.5,-632.677;Inherit;False;#pragma multi_compile_fragment _ _REFLECTION_PROBE_BLENDING$#pragma multi_compile_fragment _ _REFLECTION_PROBE_BOX_PROJECTION$// 反射Probeを使用するために必要$#if UNITY_VERSION >= 60010000 // Unity6.1.0 URP17.1 以上$	#pragma multi_compile_fragment _ _CLUSTER_LIGHT_LOOP$#elif UNITY_VERSION >= 202220 // Unity2022.2.0 URP14.0 以上$	#pragma multi_compile_fragment _ _FORWARD_PLUS$#endif;7;Create;1;True;In0;FLOAT;0;In;;Inherit;False;Pragma MultiCompile;False;True;0;;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=76F034BF944DCA85474147A4841AF9FDCDE80597
